...
The controls for my game will be made for the standard QWERTY keyboard because this is the most common keyboard layout around the world. [(KeySource China Limited, 2011)](reference-list.md#features-of-a-proposed-solution) I want the controls to be easy to use and to learn. My game's controls were influenced by [this discussion](https://forum.unity.com/threads/most-common-keyboard-mouse-inputs-for-pc-games.380594/) in the unity forums in which players discuss their preferred keybinds for certain controls.
