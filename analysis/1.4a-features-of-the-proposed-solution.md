...
The game will start with a main menu which allows the player to choose which of the characters they want to play as.

### Pause Menu

Pressing the escape key during the game will pause the game until the player clicks resume.

![](../.gitbook/assets/pausemenu.png) Example pause menu
...
The first room in floors 2 and 3 will be vendor rooms where players can purchase new weapons or powerups from a shop using gold fragments which can be collected by killing enemies. I want the shop to be similar to the shop in Enter the Gungeon except the shopkeeper will always be peaceful.
...
A small number of rooms found in the dungeon will be chest rooms. A chest room will contain a chest which the player can open to be rewarded with some coins and a random weapon.
