...
| Bullet-hell aspects           | _Enter the Gungeon_ is a bullet hell roguelike game. I'd like to include parts of this theme in my game because I think it will be a fun premise and dodging the projectiles will be a key part of my game.                                                                     |
...
| Feature     | Justification                                                                                                                                                                                                                                                                                          |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Boss fights | A boss fight provides a momentary rise in intensity or a climax in a game which tests the player in some way or another. [(Stout, 2010)](../5-references/reference-list.md#1.3-research) I'd like to include a boss fight in my game to challenge the player as the ultimate end goal and achievement. |
