...
_Soul Knight_ is a top-down dungeon crawler developed by ChillyRoom where the ultimate goal is to reach the end of the dungeon. Players achieve this by using weapons which can be found or bought throughout the dungeon to defeat enemies in each room and bosses at the end of certain stages. Bosses are essentially strong enemies with high amounts of health and powerful attacks. Players begin the game with a character of their choosing. As they play through the dungeon, players can collect crafting materials and gems which can be used in the lobby to create new weapons and unlock new characters to play as. Each character has different statistics and a different ability which can be activated after cooldown. [(Koziara, 2017)](reference-list.md#research)
