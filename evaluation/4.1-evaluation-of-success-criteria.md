...
I did not include powerups in my game due to time constraints. I would have liked to include this feature but I decided to spend my time on more critical features instead. Initially, I planned to sell permanent and temporary powerups in the shop and also have them as chest rewards, however now the way I would implement powerups has changed. I think powerups would fit better into my game if there was a rare chance for a powerup to spawn when a box is destroyed and if they were temporary only. This would make boxes feel more useful and be rewarding for the player as it gives them additional functionality. I will discuss what I would like to have done with powerups later in [Maintenance and Future Development](4.3-maintenance-and-future-development.md).
